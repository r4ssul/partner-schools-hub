/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/r2-file-api/wrangler.jsonc --env-file=cloudflare/r2-file-api/.dev.vars.example --strict-vars=false cloudflare/r2-file-api/src/worker-configuration.d.ts` (hash: 7c09afe42851251f556790a73990d707)
