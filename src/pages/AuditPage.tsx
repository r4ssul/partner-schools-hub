...
export default function AuditPage() {
  ...
  return (
    <div className="page feature-page">
      ...
      <section className="content-surface audit-controls">
        <header><ShieldAlert size={23} /><div><h2>Log controls</h2><p>Available to owners and super admins. Cleared history cannot be restored.</p></div></header>
